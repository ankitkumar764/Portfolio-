    ...
    return (
        <section id="skills" style={{ padding: '120px 24px', background: 'transparent' }}>
            <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                ...
                >
                    <p style={{ fontFamily: "'Outfit', sans-serif", color: '#d4af37', fontSize: '13px', fontWeight: '600', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '16px' }}>Expertise</p>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                        <h2 style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: '800', color: '#f8fafc', letterSpacing: '-1.5px' }}>Technical Stack.</h2>
                        ...
                        >
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(100px, 1fr))', gap: '16px' }}>
                                {cat.skills.map((skill, si) => (
                                    ...
                                    >
                                        <div style={{ fontSize: '28px', color: '#d4af37', opacity: 0.9 }}>
                                            {skill.icon}
                                        </div>
                                        <span style={{ 
                                            fontSize: '11px', 
